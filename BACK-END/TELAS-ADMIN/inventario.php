...
if ($filtro !== "todos" && isset($grupos[$filtro])) {
    ...
    <head>
        ...
        <link rel="stylesheet" href="../../FRONT-END/CSS/TELAS-ADMIN/inventario.css">
    </head>
    <body>
    ...
    <a href="./../auth/logout.php" class="topbar-btn ghost" style="text-decoration: none;"><i class="fas fa-sign-out-alt"></i></a>
        ...
        <div class="content">
            ...
            <div class="cards-grid" id="cardsContainer">
                ...
                <?php /*    <!-- <div class="card" data-cat="<?= h($cat) ?>" data-grupo="<?= h($grupo) ?>" data-name="<?= h($nome) ?>" data-qty="<?= h($quantidade) ?>" data-status="<?= h($status) ?>"> --> */?>
...
// ====== SEARCH & FILTER ======
        function filterCards() {
            ...
            cards.forEach(card => {
                ...
                // Se a busca estiver vazia, exibe tudo
                if (query === '') {
                    card.style.display = '';
                    return;
                }

                const matchSearch = name.includes(query) || cat.includes(query) || grupo.includes(query);
