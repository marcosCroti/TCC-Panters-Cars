...
if ($pecas) {
    ...
    $aprovadas = $pecas["pecas_aprovadas"]; 
    $reprovadas = $pecas["pecas_reprovadas"];

    if($pecas["pecas_aprovadas"]){
        $aprovadas = "";
    
        } else {
            $pecas = "pecas_reprovadas";
    }
}
?>
...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="quick-cards">
            ...
            <a href="#" class="qcard" onclick="showToast('📦 Abrindo Inventário...')">
            ...
            <a href="#" class="qcard" onclick="showToast('👥 Abrindo Funcionários...')">
            ...
            <a href="#" class="qcard" onclick="showToast('📊 Abrindo Qualidade...')">
            ...
            <a href="#" class="qcard" onclick="openAlertsModal()">
